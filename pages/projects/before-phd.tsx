...
const projects: Project[] = [
  {
  title: "ESP32-CAM: “Camera init failed (0xFFFFFFFF)” — Root Cause & Fix",
  blurb:
  "I investigated and resolved the Common ESP32-CAM failure (“Camera init failed 0xFFFFFFFF”). Final fix combined: correct board profile & pin map (AI Thinker), stable 5V supply, reseated camera ribbon, clean flash + re-flash. The video walkthrough has helped thousands of makers (9K+) reproduce the fix quickly.",
  img: "/projects/esp32-fix.png",
  link: "https://www.youtube.com/watch?v=Xv3bgk_ZV5I&t=2s", // YouTube link 
  },
...
export default function BeforePhD() {
  return (
    <Layout title="Before PhD" description="Projects completed before my PhD.">
      <h1 className="text-3xl font-bold mb-6">Before PhD</h1>
